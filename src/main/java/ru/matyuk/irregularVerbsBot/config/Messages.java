...
public final class Messages {
    ...
    public static final String UNKNOWN_MESSAGE = "Не знаю такую команду :pensive:";
    public static final String CHOOSE_GROUP_MESSAGE = "Выбирете группу";
    ...
    public static final String SELECTED_GROUP_MESSAGE = "Выбрана группа для изучения: %s";
    public static final String NO_GROUP_MESSAGE = "Нет такой группы";
    public static final String GROUP_IS_EMPTY_MESSAGE = "Группа пуста";
    public static final String NEED_CHOOSE_GROUP_MESSAGE = "Нужно выбрать группу для изучения";
